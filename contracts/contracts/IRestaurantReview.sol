...
interface IRestaurantReview {
    function createRestaurant(string memory _country, string memory _city, string memory _restaurantAddress, string memory _restaurantName) external returns (uint);
